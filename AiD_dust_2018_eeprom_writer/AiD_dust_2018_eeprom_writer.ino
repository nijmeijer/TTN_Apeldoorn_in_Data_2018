...
// This should also be in big endian format (MSB..LSB)
static const uint8_t APPKEY[16] = { 0x89, 0x61, 0xC3, 0x49, 0x7C, 0x82, 0x50, 0x06, 0x71, 0xE0, 0xA3, 0x84, 0x30, 0x88, 0xAA, 0x96 }; // AID Dust Sensors 2018
